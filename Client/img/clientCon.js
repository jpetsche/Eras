...
function updateHighscores() {
	var highScores = {};
	$.get("highscores.php", function(data) {
		var scores = JSON.parse(data);
		highScores = {"key" : "scores", "score1" : scores[0].HighScores, "name1" : scores[0].Username, "score2" : scores[1].HighScores, "name2" : scores[1].Username, "score3" : scores[2].HighScores, "name3" : scores[2].Username};
		var i = 0;
	});
